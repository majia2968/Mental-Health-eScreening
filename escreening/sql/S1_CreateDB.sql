...
ALTER TABLE [dbo].[assessment_var_children]
 ADD CONSTRAINT [fk_assessment_variable_child]
 FOREIGN KEY 
   ([variable_child])
 REFERENCES 
   [sdc-prod].[dbo].[assessment_variable]     ([assessment_variable_id])
...
ALTER TABLE [dbo].[export_log]
 ADD CONSTRAINT [fk_export_type_el]
 FOREIGN KEY 
   ([export_type_id])
 REFERENCES 
...
ALTER TABLE [dbo].[rule_event]
 ADD CONSTRAINT [fk_rule_event_event]
 FOREIGN KEY 
   ([event_id])
 REFERENCES 
...
IF EXISTS (SELECT * FROM sys.objects so JOIN sys.schemas sc ON so.schema_id = sc.schema_id WHERE so.name = N'fk_survey_meas_resp_vm'  AND sc.name=N'dbo'  AND type in (N'F'))
ALTER TABLE [dbo].[survey_measure_response] DROP CONSTRAINT [fk_survey_meas_resp_vm]
 GO



ALTER TABLE [dbo].[survey_measure_response]
 ADD CONSTRAINT [fk_survey_meas_resp_vm]
 FOREIGN KEY 
   ([measure_id])
 REFERENCES 
   [sdc-prod].[dbo].[measure]     ([measure_id])
...
IF EXISTS (SELECT * FROM sys.objects so JOIN sys.schemas sc ON so.schema_id = sc.schema_id WHERE so.name = N'fk_survey_meas_resp_vma'  AND sc.name=N'dbo'  AND type in (N'F'))
ALTER TABLE [dbo].[survey_measure_response] DROP CONSTRAINT [fk_survey_meas_resp_vma]
 GO



ALTER TABLE [dbo].[survey_measure_response]
 ADD CONSTRAINT [fk_survey_meas_resp_vma]
 FOREIGN KEY 
   ([measure_answer_id])
 REFERENCES 
   [sdc-prod].[dbo].[measure_answer]     ([measure_answer_id])
...
ALTER TABLE [dbo].[variable_template]
 ADD CONSTRAINT [fk_assessment_variable]
 FOREIGN KEY 
   ([assessment_variable_id])
 REFERENCES 
   [sdc-prod].[dbo].[assessment_variable]     ([assessment_variable_id])
...
ALTER TABLE [dbo].[veteran_assessment_survey]
 ADD CONSTRAINT [fk_veteran_assess_survey_pa]
 FOREIGN KEY 
   ([veteran_assessment_id])
 REFERENCES 
   [sdc-prod].[dbo].[veteran_assessment]     ([veteran_assessment_id])
